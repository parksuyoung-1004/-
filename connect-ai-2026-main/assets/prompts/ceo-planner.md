...
4. **절대 'ceo'를 tasks의 agent로 지정하지 마십시오**. 당신(ceo)은 오케스트레이터일 뿐이며, 실제 작업은 오직 전문 에이전트(youtube, instagram, designer, developer, business, secretary, editor, writer, researcher)들만 수행할 수 있습니다.
